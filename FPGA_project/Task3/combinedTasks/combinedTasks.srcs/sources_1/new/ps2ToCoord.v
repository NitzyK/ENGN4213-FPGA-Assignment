...
always @(*) begin
		case(letter)
			...
			8'h00 : coordinates = 6'b010101; //x (k)
			
			8'h4B : coordinates = 6'b011001; //L
			8'h00 : coordinates = 6'b011010; //x (m)
			8'h31 : coordinates = 6'b011011; //n
			8'h44 : coordinates = 6'b011100; //O
			8'h4D : coordinates = 6'b011101; //P
			
			8'h00 : coordinates = 6'b100001; //x (q)
			8'h2D : coordinates = 6'b100010; //r
			8'h1B : coordinates = 6'b100011; //S
			8'h2C : coordinates = 6'b100100; //t
			8'h3C : coordinates = 6'b100101; //U
			
			8'h00 : coordinates = 6'b101001; //x (v)
			8'h00 : coordinates = 6'b101010; //x (w)
			8'h00 : coordinates = 6'b101011; //x (x)
			8'h00 : coordinates = 6'b101100; //x (y)
			8'h00 : coordinates = 6'b101101; //x (z)
