...
initial begin
        ...
        polybius_flat[17] = 8'h00;  // x (v)
        polybius_flat[18] = 8'h00;  // x (w)
        polybius_flat[19] = 8'h00;  // x (x)
        polybius_flat[20] = 8'h00;  // x (y)
        polybius_flat[21] = 8'h00;  // x (z)


end
    

wire [4:0] extract_coords = ((m_coords - 1) * 5) + (n_coords - 1);
